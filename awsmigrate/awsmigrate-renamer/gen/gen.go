...
func (p *pkg) buildRenames() {
	pkgName := "github.com/gosemver/aws_aws-sdk-go_v1.4.3-1-g1f24fa1/service/" + p.oldAPI.PackageName()
	if exportMap[pkgName] == nil {
		exportMap[pkgName] = &packageRenames{map[string]string{}, map[string]string{}, map[string]string{}}
	}
	ifacename := "github.com/gosemver/aws_aws-sdk-go_v1.4.3-1-g1f24fa1/service/" + p.oldAPI.PackageName() + "/" +
